...
- Removed legacy Bash-only implementation artifacts from the repository (`src/theme-manager.sh`, `bin/theme-manager`, Bash sample configs, and legacy Bats tests).
